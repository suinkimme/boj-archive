...
export function ContributionNudge() {
  ...
  return (
    <>
      {/* 모바일: 하단 전체 너비 바 */}
      <div className="sm:hidden fixed bottom-0 inset-x-0 z-40 bg-surface-card border-t border-border-list">
        <div className="flex items-center gap-3 px-4 py-3">
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-bold text-text-primary">직접 문제를 만들 수 있습니다</p>
            <p className="text-[11px] text-text-secondary mt-0.5">풀어보고 싶었던 문제가 있으신가요?</p>
          </div>
          <a
            href="https://github.com/suinkimme/next-judge/blob/main/CONTRIBUTING.md"
            target="_blank"
            rel="noreferrer noopener"
            className="flex-shrink-0 bg-brand-red text-white text-[11px] font-bold px-3 py-1.5 hover:opacity-90 transition-opacity whitespace-nowrap"
          >
            출제하기 →
          </a>
          <button
      ...
      {/* 데스크톱: 우하단 카드 */}
      <div className="hidden sm:block fixed bottom-6 right-6 z-40 w-[280px] bg-surface-card border border-border-list shadow-lg">
        ...
        <p className="px-4 pb-4 text-[12px] text-text-secondary leading-relaxed break-keep">
          풀어보고 싶었던 문제가 있으신가요? 출제해보세요! 제발... 살려줏메.
        </p>
