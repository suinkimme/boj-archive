...
const blocks: Block[] = [
  ...
  heading2("문제 탐색"),
  paragraph(
    "33,000개 이상의 알고리즘 문제를 한 곳에서 탐색할 수 있습니다. 키워드 검색과 난이도 필터로 원하는 문제를 빠르게 찾아보세요."
  ),
  ...
  // 5. 로그인 & 아이디 연동 & 마이 페이지
  heading2("로그인, 아이디 연동, 마이 페이지"),
  paragraph(
    "계정을 만들고 로그인할 수 있습니다. solved.ac 아이디를 연동하면 지금까지 풀었던 문제 이력을 한 번에 가져올 수 있어요. 연동하지 않아도 채점은 자유롭게 이용할 수 있습니다."
  ),
  paragraph(
